...
public:
	...
	//unsigned long Reflect(unsigned long ref, char ch); // Reflects CRC bits in the lookup table  [反映查找表中的CRC位]
    unsigned int Reflect(unsigned int ref, char ch); // Reflects CRC bits in the lookup table [在查找表中反映 CRC 位]
